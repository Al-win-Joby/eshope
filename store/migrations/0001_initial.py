    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desciption', models.TextField(blank=True, max_length=200)),
                ...
                ('subcategory_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='category.subcategory')),
            ],
        ),
    ]
